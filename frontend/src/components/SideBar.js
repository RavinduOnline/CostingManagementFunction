    ...
    return (
              ...
              <div className="dash_container">	
                <div className="dashbtnbox">
                    ...
                    <a style={{textDecoration:'none', color:'white'}} href="/customer"><button type="button" className="dashbtn06">User Accounts</button></a>
                    <a style={{textDecoration:'none', color:'white'}} href="/"><button type="button" className="dashbtn07">Staff</button></a>
                    <a style={{textDecoration:'none', color:'white'}} href="/"><button type="button" className="dashbtn08">Payment</button></a>
