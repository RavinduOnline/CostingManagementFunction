...
<div className = "display">
          ...
          <div className="col-md-8 mt-4 mx-auto" id="updateCos">

            <h5 className="addUpTitle">{this.state.name}</h5>
       
            
        <form className="needs-validation" id="updateCosPopForm" noValidate>
            ...
            <div className="form-group" style={{marginBottom:'15px'}}>
              ...
              <a href="/costing">
                <button id="UpdateButDiv"  className="btn btn-secondary"> <i class="fas fa-chevron-left">
                  </i> &nbsp;BACK</button> 
                </a>

                <button  id="UpdateButDiv" id="updateBtn1" className="btn btn-success" data-toggle="modal" data-target="#myModaledit"> <i className="fas fa-edit" id ="updateBtn2" >
                </i>&nbsp;UPDATE</button>
